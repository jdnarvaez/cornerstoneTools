/*! cornerstone-tools - 2.1.1-rc1 - 2018-03-22 | (c) 2017 Chris Hafey | https://github.com/cornerstonejs/cornerstoneTools */
...
exports.default = function (element, newImageIdIndex) {
  ...
  function doneCallback(image) {
    ...
    if (stackRenderer) {
      ...
      var viewport = viewportProvider && viewportProvider.data && viewportProvider.data.length > 0 ? viewportProvider.data[0].getViewport(enabledElement, image, stackData) : undefined;
      cornerstone.displayImage(element, image, viewport);
    }
