...
export default function (element, newImageIdIndex) {
  ...
  function doneCallback (image) {
    ...
    if (stackRenderer) {
      ...
      const viewport = viewportProvider && viewportProvider.data && viewportProvider.data.length > 0 ? viewportProvider.data[0].getViewport(enabledElement, image) : undefined;
